...
![추천 결과 예시 1](assets/demo/screenshot_result_1.png)
![추천 결과 예시 2](assets/demo/screenshot_result_2.png)
![추천 결과 예시 3](assets/demo/screenshot_result_3.png)

**행정동 상·하위 비교**

![행정동 상하위 비교](assets/demo/screenshot_ranking_compare.png)
